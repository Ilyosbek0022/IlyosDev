      ...
      <div className="footer-content">
        ...
        <div className="footer-socials">
          ...
          <a href="https://github.com/Ilyosbek0022/Ilyosbek022" className="icon-card" aria-label="GitHub">
            <svg height="26px" width="26px" viewBox="0 0 30 30" className="github">
          ...
          <a href="https://x.com/Ilyosbek0224" className="icon-card" aria-label="Twitter">
            <svg height="26px" width="26px" viewBox="0 0 48 48" className="twitter">
              <path d="M42,12.429c-1.323,0.586-2.746,0.977-4.247,1.162c1.526-0.906,2.7-2.351,3.251-4.058
              ...
              c0,2.541,1.301,4.778,3.285,6.096c-1.211-0.037-2.351-0.374-3.349-0.914c0,0.022,0,0.055,0,0.086
          ...
          <Link href="https://t.me/NuriddinovIlyosbek" className="icon-card" aria-label="Telegram">
            <svg height="26px" width="26px" viewBox="0 0 24 24" className="telegram">
              ...
              -.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69.03-.09.06-.17-.06-.26-.12-.09-.3-.06-.43-.04
              -.18.03-3.1 1.97-4.37 2.89-.4.29-.76.43-1.09.42-.36-.01-1.06-.2-1.57-.37-.63-.2-1.12-.31-1.08-.66
              .02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 7.36-3.45.83-.44 1.66-.67 2.08-.57.54.13.87.5.8 1.48z" 
              fill="currentColor"/>
            </svg>
          </Link>
        </div>
